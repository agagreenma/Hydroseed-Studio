// Mock content for the public HYDROSEED Journal sections.
...
export const ARTICLES: Article[] = [
  {
    ...
    body: [
      { paragraph: "On a cut slope outside a new interchange, a three-person crew lays down a bonded fibre matrix in under an hour. The crew lead is a former landscaper. Nothing about this scene would have been legible five years ago." },
      { heading: "A slow-motion transition", paragraph: "The story of hydroseeding in the 2020s is not one of hype cycles. It is a slow-motion transition, driven by the mundane arithmetic of tank capacity and labour." },
      { heading: "What contractors are actually doing", paragraph: "Contractors are quietly rebuilding their operations around software: bid estimating, mix tracking, and site scheduling running side by side." },
      { paragraph: "The industrial revegetation crew is here. It just doesn't look like the render." },
    ],
  },
  {
    ...
    body: [
      { paragraph: "The first truck rolls out at 06:00. A rain delay the day before pushed the schedule into the weekend and the crew is chasing daylight." },
      { heading: "Rhythm of the site", paragraph: "Everything runs on a rhythm: seed mix loaded at dawn, application by mid-morning, tackifier set by early afternoon. Deviation from the rhythm is the enemy." },
      { paragraph: "By Friday the last slope is covered. The foreman walks the site, checks coverage, and closes the week." },
    ],
  },
  {
    ...
    body: [
      ...
      { heading: "Establishment rate is the real number", paragraph: "A hydroseeding job exists to convert seed, mulch and water into durable, established vegetation cover." },
      { paragraph: "Track that, and the correct mix and re-application conversations start to happen on their own." },
    ],
  },
  {
    ...
    body: [
      { paragraph: "\"We do not need heroic coverage numbers. We need a crew that shows up on the day the grading inspector signs off.\"" },
      { heading: "Reliability over novelty", paragraph: "The project manager is unambiguous: schedule reliability, not novelty, wins repeat work." },
      { heading: "Paperwork is the second theme", paragraph: "Everything is a document. Application logs, mix tickets, site photos — every document is a decision." },
    ],
  },
  {
    ...
    body: [
      ...
      { heading: "The unseen 30%", paragraph: "Mobilisation, water hauling, and site prep routinely take a third of the total budget." },
      { paragraph: "Design decisions that reduce re-mobilisation pay back faster than any mix upgrade." },
    ],
  },
  {
    ...
    body: [
      { paragraph: "For a decade, the default for roadside revegetation was a fast, generic turf mix. In 2026 more specifications call for a regional native blend instead." },
      { paragraph: "Native mixes paired with bonded fibre matrix are quietly setting new benchmarks for long-term slope stability per dollar of contract value." },
    ],
  },
];
...
export const RESOURCES: Resource[] = [
  {
    ...
    summary: "A 42-page guide covering equipment selection, mix sourcing, unit economics and go-to-market for a professional hydroseeding operation.",
    type: "Guide",
    category: "Operations",
    minutes: 45,
    updated: "2026-07-14",
    ...
    chapters: [
      { title: "1. Choosing the right tank and truck", body: "Tank capacity, agitation system, hose length, and access for a work truck are the four things that matter most." },
      { title: "2. Mix sourcing and storage", body: "Buy seed and mulch from three suppliers minimum, rotate stock every season, and store cool and dry." },
      { title: "3. Unit economics", body: "Model contribution margin per acre, not per bag. Everything else follows." },
      { title: "4. Contractor go-to-market", body: "Two general contractors a week for eight weeks builds a pipeline." },
    ],
  },
  {
    slug: "job-scheduling-playbook",
    title: "Job scheduling playbook",
    summary: "Templates and workflows for weekly and seasonal job scheduling for revegetation crews.",
    type: "Playbook",
    category: "Operations",
    minutes: 30,
    updated: "2026-07-05",
  ...
  },
  {
    ...
    chapters: [
      { title: "The three-tier model", body: "Public bid, private contract, homeowner retail — priced from cost, not from feel." },
  ...
  },
  {
    ...
    summary: "An annual report on capacity, equipment, fuel and labour trends across regional erosion control contractors.",
    type: "Report",
    category: "Finance",
    minutes: 25,
    updated: "2026-06-15",
  ...
  },
  {
    ...
    summary: "Checklists, SOP templates and audit prep material for stormwater and erosion control site inspections.",
    type: "Toolkit",
    category: "Compliance",
    minutes: 40,
    updated: "2026-06-01",
...
export const COURSES: Course[] = [
  {
    ...
    outline: [
      ...
      { module: "Module 2 — Revegetation science essentials", lessons: ["Germination for operators", "Soil, moisture, and mulch", "Common site failures"] },
      { module: "Module 3 — Equipment fundamentals", lessons: ["Tank and pump layout", "Mix ratios", "Water logistics"] },
    ],
  },
  {
    ...
    cover: img("1500382017468-9049fed747ef"),
    outline: [
      { module: "Module 1 — The schedule of record", lessons: ["Cycles and cadence", "Batching jobs", "Weather buffers"] },
  ...
  },
  {
    ...
    outline: [
      ...
      { module: "Module 2 — Channels", lessons: ["Public bids", "General contractors", "Residential retail"] },
    ],
  },
  {
  ...
  },
  {
    ...
    tagline: "BFM, SMM and turf reinforcement mats at commercial scale — design and apply for reliability.",
    level: "Advanced",
    track: "Operations",
    hours: 9,
    lessons: 30,
...
export const CASE_INDUSTRIES = ["All", "Civil Construction", "Roadside & Infrastructure", "Mining & Restoration", "Commercial Landscaping"];
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    summary: "A regional civil construction firm consolidated bidding, scheduling and job tracking on HYDROSEED.APP.",
    ...
    quote: { text: "For the first time our three regions are running on one schedule.", author: "Ines de Vries", role: "COO, Northline Civil" },
    story: [
      { heading: "The context", body: "Three regions, three spreadsheets, three definitions of the truth." },
      { heading: "The rollout", body: "Six weeks from kickoff to first live weekly schedule on HYDROSEED.APP." },
      { heading: "The result", body: "Bid meetings shrank from 90 minutes to 25. Estimate errors fell to under one percent." },
    ],
  },
  {
    ...
    summary: "A commercial landscaping group replaces a monthly finance close with live per-job margin.",
    ...
    quote: { text: "The finance team stopped chasing numbers and started using them.", author: "Peter Janssens", role: "CFO, Ridgeway Landscapes" },
    story: [
  ...
  },
  {
    ...
    summary: "A roadside and infrastructure revegetation contractor uses HYDROSEED.APP to add contracts without adding chaos.",
    ...
    quote: { text: "We seven-x'd our route with two extra people.", author: "Camille Roche", role: "Founder, Sierra Slope Works" },
    story: [
  ...
  },
  {
    ...
    summary: "A mining and restoration contractor unifies subcontractor onboarding, orders and application tracking.",
    ...
    quote: { text: "Every load is now traceable to a specific slope.", author: "Lena Roth", role: "Head of Ops, Cascade Reclamation" },
    story: [
...
export const HELP_CATEGORIES = [
  ...
  { slug: "production", name: "Job scheduling", description: "Cycles, jobs, mix loads and applications.", icon: "🌱" },
  { slug: "orders", name: "Bids & customers", description: "Manage public, private and residential bids.", icon: "📦" },
  { slug: "inventory", name: "Inventory", description: "Track seed, mulch, tackifier and movements.", icon: "🧺" },
  { slug: "billing", name: "Billing & plans", description: "Subscriptions, invoices and seats.", icon: "💳" },
  { slug: "integrations", name: "Integrations", description: "Connect HYDROSEED.APP to your other tools.", icon: "🔌" },
];
...
export const HELP_ARTICLES: HelpArticle[] = [
  {
    ...
    updated: "2026-07-20",
    body: [
      { heading: "Open the scheduler", paragraph: "From the sidebar, choose Jobs → Schedule and click New schedule." },
  ...
  },
  {
    ...
    body: [
      ...
      { heading: "Fulfilment", paragraph: "Assign a crew, print the job sheet, and mark the contract as Ready to schedule." },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "production",
    updated: "2026-06-28",
    body: [{ paragraph: "A job is what you sell. A cycle is how you schedule it. One cycle can generate many jobs." }],
  },
  {
...
export const RELEASES: Release[] = [
  {
    ...
    category: "New",
    summary: "A refreshed public Journal layout and a shared calendar for the content and marketing team.",
    highlights: [
      { title: "Journal redesign", body: "New article and resource layouts across hydroseed.app/journal." },
      { title: "Shared publishing calendar", body: "The Monday screen for every writer and editor on the team." },
      { title: "Slack notifications", body: "Publish, revise, and schedule events flow into any channel." },
    ],
  },
  {
    ...
    publishedAt: "2026-07-11",
    category: "New",
    summary: "Structured metadata and social preview cards computed automatically from page content.",
    highlights: [
      { title: "Auto-generated previews", body: "No more manual social card uploads for every new page." },
      { title: "Metadata sources", body: "Title, description and canonical tags allocated per page template." },
    ],
  },
  {
    ...
    highlights: [
      { title: "Faster search", body: "Keyboard-first search across guides, playbooks and reports." },
  ...
  },
  {
    ...
    highlights: [
      ...
      { title: "Field mapping", body: "Configure how HYDROSEED.APP fields map to QuickBooks fields." },
    ],
  },
  {
